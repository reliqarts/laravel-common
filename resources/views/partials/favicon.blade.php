...
<meta name="application-name" content="&nbsp;"/>
    ...
    <meta name="msapplication-square70x70logo" content="{{ asset('img/icon/mstile-70x70.png') }}" />
    <meta name="msapplication-square150x150logo" content="{{ asset('img/icon/mstile-150x150.png') }}" />
    <meta name="msapplication-wide310x150logo" content="{{ asset('img/icon/mstile-310x150.png') }}" />
    <meta name="msapplication-square310x310logo" content="{{ asset('img/icon/mstile-310x310.png') }}" />
    ...
    <link rel="apple-touch-icon-precomposed" sizes="60x60" href="{{ asset('img/icon/apple-touch-icon-60x60.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="{{ asset('img/icon/apple-touch-icon-120x120.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="76x76" href="{{ asset('img/icon/apple-touch-icon-76x76.png') }}" />
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ asset('img/icon/apple-touch-icon-152x152.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('img/icon/favicon-196x196.png') }}" sizes="196x196" />
    ...
    <link rel="icon" type="image/png" href="{{ asset('img/icon/favicon-128.png') }}" sizes="128x128" />
